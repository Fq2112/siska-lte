@extends('layouts.mst')
@section('title', 'Admins Table &ndash; '.env('APP_NAME').' Admins | SISKA &mdash; Sistem Informasi Karier')
@section('content')
                                    ...
                                    <td style="vertical-align: middle" align="center">
                                        <img class="img-responsive" width="100" alt="avatar.png"
                                             src="{{$admin->ava == "" || $admin->ava == "avatar.png" ?
                                                 asset('images/avatar.png') : asset('storage/admins/ava/'.$admin->ava)}}">
                                    </td>
