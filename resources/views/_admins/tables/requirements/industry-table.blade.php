@extends('layouts.mst')
@section('title', 'Industries Table &ndash; '.env('APP_NAME').' Admins | SISKA &mdash; Sistem Informasi Karier')
@section('content')
                            ...
                            @foreach($industries as $industry)
                                <tr>
                                    ...
                                    <td style="vertical-align: middle" align="center">
                                        <img class="img-responsive" width="64" alt="{{$industry->icon != "" ? $industry
                                        ->icon : 'Icon'}}" src="{{asset('images/industries/'.$industry->icon)}}">
                                    </td>
                                    <td style="vertical-align: middle"><strong>{{$industry->name}}</strong></td>
                                    ...
                                    <td style="vertical-align: middle" align="center">
                                        <a onclick='editIndustry("{{$industry->id}}","{{$industry->name}}","{{$industry->icon}}")'
