...
<div id="carousel-example" class="carousel slide carousel-fullscreen" data-ride="carousel">
    <div class="carousel-inner">
        <div class="item" style="background-image: url({{asset('images/carousels/c1.jpg')}});">
        ...
        <div class="item" style="background-image: url({{asset('images/carousels/c2.png')}});">
            <div class="carousel-overlay"></div>
            <div class="carousel-caption">
                <h1 class="line-1 anim-typewriter">Selamat datang di {{env('APP_TITLE')}}!</h1>
                <a href="{{route('welcome')}}">
        ...
        <div class="item" style="background-image: url({{asset('images/carousels/c3.jpg')}});">
            <div class="carousel-overlay"></div>
            <div class="carousel-caption">
                <h1 class="line-1 anim-typewriter">Selamat datang di {{env("APP_TITLE")}}!</h1>
                <a href="{{route('welcome')}}">
