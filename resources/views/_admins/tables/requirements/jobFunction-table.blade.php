@extends('layouts.mst')
@section('title', 'Job Functions Table &ndash; '.env('APP_NAME').' Admins | SISKA &mdash; Sistem Informasi Karier')
@section('content')
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered">
                            ...
                            @foreach($functions as $function)
                                <tr>
                                    ...
                                    <td style="vertical-align: middle"><strong>{{$function->name}}</strong></td>
                                    ...
                                    <td style="vertical-align: middle" align="center">
                                        <a onclick='editJobFunction("{{$function->id}}","{{$function->name}}")'
